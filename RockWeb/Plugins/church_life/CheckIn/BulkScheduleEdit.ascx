<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BulkScheduleEdit.ascx.cs" Inherits="RockWeb.Plugins.CheckIn.BulkScheduleEdit" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="grid">
                    <Rock:Grid ID="gDefinedValueSchedule" runat="server" AllowSorting="true" AllowPaging="false" OnRowDataBound="gDefinedValueSchedule_RowDataBound" >
                        <Columns>
